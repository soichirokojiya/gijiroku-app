...
テキストに「話者1:」「話者2:」のような話者ラベルが含まれている場合は、誰が何を発言したかを議事録に反映してください。
discussionフィールドでは「話者1が〜と提案し、話者2が〜と回答した」のように発言者を明記してください。

以下のJSON形式で返してください:
{
  "title": "会議のタイトル（内容から推測）",
  "summary": "会議の概要（2-3文）",
  "participants": ["話者1", "話者2"（名前がわかれば名前に置き換え）],
  "agendaItems": [
    {
      "topic": "議題",
      "discussion": "議論の内容（誰が何を言ったか明記）",
      "decisions": ["決定事項"],
      "actionItems": ["アクションアイテム（担当者を明記）"]
    }
  ],
  "nextSteps": ["次のステップ"],
  "notes": "その他の補足事項"
